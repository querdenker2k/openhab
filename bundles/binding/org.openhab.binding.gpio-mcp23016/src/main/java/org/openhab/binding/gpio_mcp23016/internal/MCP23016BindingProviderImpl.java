 ...
 * @since 1.6.0
 */
public class MCP23016BindingProviderImpl extends AbstractGenericBindingProvider implements MCP23016BindingProvider {
	private static final Logger logger = LoggerFactory.getLogger(MCP23016BindingProviderImpl.class);
	...
	public void processBindingConfiguration(String context, Item item, String bindingConfig) throws BindingConfigParseException {
		...
		super.bindingConfigs.put(item.getName(), new MCP23016ItemConfig(item, port, bank, in, pollInterval));
	}
	...
	@Override
	public MCP23016ItemConfig getItemConfig(String itemName) {
		return (MCP23016ItemConfig) super.bindingConfigs.get(itemName);
	}
